 ...
 */
gboolean
cobiwm_actor_vertices_are_untransformed (ClutterVertex *verts,
                                       float          widthf,
                                       float          heightf,
                                       int           *x_origin,
                                       int           *y_origin)
 ...
 */
gboolean
cobiwm_actor_is_untransformed (ClutterActor *actor,
                             int          *x_origin,
                             int          *y_origin)
{
  ...
  return cobiwm_actor_vertices_are_untransformed (verts, widthf, heightf, x_origin, y_origin);
}

/**
 * cobiwm_actor_painting_untransformed:
 ...
 * This can differ from the result of cobiwm_actor_is_untransformed() when
 ...
 */
gboolean
cobiwm_actor_painting_untransformed (int              paint_width,
                                   int              paint_height,
                                   int             *x_origin,
                                   int             *y_origin)
{
  ...
  return cobiwm_actor_vertices_are_untransformed (vertices, paint_width, paint_height, x_origin, y_origin);
}
