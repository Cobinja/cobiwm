...
/**
 * cobiwm_texture_tower_new:
 *
 * Creates a new texture tower. The base texture has to be set with
 * cobiwm_texture_tower_set_base_texture() before use.
 *
 * Return value: the new texture tower. Free with cobiwm_texture_tower_free()
 */
CobiwmTextureTower *
cobiwm_texture_tower_new (void)
{
  CobiwmTextureTower *tower;

  tower = g_slice_new0 (CobiwmTextureTower);

  return tower;
}

/**
 * cobiwm_texture_tower_free:
 * @tower: a #CobiwmTextureTower
 *
 * Frees a texture tower created with cobiwm_texture_tower_new().
 */
void
cobiwm_texture_tower_free (CobiwmTextureTower *tower)
{
  ...
  cobiwm_texture_tower_set_base_texture (tower, NULL);

  g_slice_free (CobiwmTextureTower, tower);
}

/**
 * cobiwm_texture_tower_set_base_texture:
 * @tower: a #CobiwmTextureTower
 ...
 */
void
cobiwm_texture_tower_set_base_texture (CobiwmTextureTower *tower,
                                     CoglTexture      *texture)
{
  int i;
  ...
  if (tower->textures[0] != NULL)
    {
      ...
      cobiwm_texture_tower_update_area (tower, 0, 0, width, height);
    }
  else
    {
      tower->n_levels = 0;
...
/**
 * cobiwm_texture_tower_update_area:
 * @tower: a #CobiwmTextureTower
 ...
 */
void
cobiwm_texture_tower_update_area (CobiwmTextureTower *tower,
                                int               x,
                                int               y,
                                int               width,
                                int               height)
...
static void
texture_tower_create_texture (CobiwmTextureTower *tower,
                              int               level,
                              int               width,
                              int               height)
{
  if ((!is_power_of_two (width) || !is_power_of_two (height)) &&
      cobiwm_texture_rectangle_check (tower->textures[level - 1]))
    {
...
static void
texture_tower_revalidate (CobiwmTextureTower *tower,
                          int               level)
{
...
/**
 * cobiwm_texture_tower_get_paint_texture:
 * @tower: a #CobiwmTextureTower
 *
 ...
 */
CoglTexture *
cobiwm_texture_tower_get_paint_texture (CobiwmTextureTower *tower)
{
  int texture_width, texture_height;
  int level;
