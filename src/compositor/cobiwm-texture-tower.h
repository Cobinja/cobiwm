...
#ifndef __COBIWM_TEXTURE_TOWER_H__
#define __COBIWM_TEXTURE_TOWER_H__
...
/**
 * SECTION:CobiwmTextureTower
 * @short_description: mipmap emulation by creation of scaled down images
 *
 * A #CobiwmTextureTower is used to get good looking scaled down images when
...
typedef struct _CobiwmTextureTower CobiwmTextureTower;

CobiwmTextureTower *cobiwm_texture_tower_new               (void);
void              cobiwm_texture_tower_free              (CobiwmTextureTower *tower);
void              cobiwm_texture_tower_set_base_texture  (CobiwmTextureTower *tower,
                                                        CoglTexture      *texture);
void              cobiwm_texture_tower_update_area       (CobiwmTextureTower *tower,
                                                        int               x,
                                                        int               y,
                                                        int               width,
                                                        int               height);
CoglTexture      *cobiwm_texture_tower_get_paint_texture (CobiwmTextureTower *tower);

G_BEGIN_DECLS

#endif /* __COBIWM_TEXTURE_TOWER_H__ */
