...
/**
 * cobiwm_create_texture_pipeline:
 ...
 */
CoglPipeline *
cobiwm_create_texture_pipeline (CoglTexture *src_texture)
{
 ...
 *
 * If %COBIWM_TEXTURE_ALLOW_SLICING is present in @flags, and the texture
 ...
 */
CoglTexture *
cobiwm_create_texture (int                   width,
                     int                   height,
                     ...
                     CobiwmTextureFlags      flags)
{
  ...
  if ((flags & COBIWM_TEXTURE_ALLOW_SLICING) != 0)
    {
