 ...
 */
gboolean cobiwm_bell_notify (CobiwmDisplay *display,
                           CobiwmWindow  *window);

/**
 * cobiwm_bell_set_audible:
 * @display: The display we're configuring
 * @audible: True for an audible bell, false for a visual bell
 *
 * Turns the bell to audible or visual. This tells X what to do, but
 * not Cobiwm; you will need to set the "visual bell" pref for that.
 *
 * If the configure script found we had no XKB, this is a no-op.
 */
void cobiwm_bell_set_audible (CobiwmDisplay *display, gboolean audible);
 ...
 */
gboolean cobiwm_bell_init (CobiwmDisplay *display);

/**
 * cobiwm_bell_shutdown:
 * @display: The display which is closing
 *
 * Shuts down the bell subsystem.
 *
 * \bug This is never called! If we had XkbSetAutoResetControls
 * enabled in cobiwm_bell_init(), this wouldn't be a problem, but
 * we don't.
 */
void cobiwm_bell_shutdown (CobiwmDisplay *display);
 ...
 */
void cobiwm_bell_notify_frame_destroy (CobiwmFrame *frame);
