 ...
 * SECTION:errors
 * @title: Errors
 * @short_description: Cobiwm X error handling
 */
...
void
cobiwm_error_trap_push (CobiwmDisplay *display)
{
  gdk_error_trap_push ();
}

void
cobiwm_error_trap_pop (CobiwmDisplay *display)
{
  gdk_error_trap_pop_ignored ();
}

int
cobiwm_error_trap_pop_with_return  (CobiwmDisplay *display)
{
