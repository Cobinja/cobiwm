...
static void
handle_pinch_begin (CobiwmWaylandPointer *pointer,
...
static void
handle_pinch_update (CobiwmWaylandPointer *pointer,
                     const ClutterEvent *event)
{
  CobiwmWaylandPointerClient *pointer_client;
  struct wl_resource *resource;
...
static void
handle_pinch_end (CobiwmWaylandPointer *pointer,
                  const ClutterEvent *event)
{
  CobiwmWaylandPointerClient *pointer_client;
  struct wl_resource *resource;
...
gboolean
cobiwm_wayland_pointer_gesture_pinch_handle_event (CobiwmWaylandPointer *pointer,
                                                 const ClutterEvent *event)
{
...
void
cobiwm_wayland_pointer_gesture_pinch_create_new_resource (CobiwmWaylandPointer *pointer,
