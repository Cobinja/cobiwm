...
static void
handle_swipe_begin (CobiwmWaylandPointer *pointer,
...
static void
handle_swipe_update (CobiwmWaylandPointer *pointer,
                     const ClutterEvent *event)
{
  CobiwmWaylandPointerClient *pointer_client;
  struct wl_resource *resource;
...
static void
handle_swipe_end (CobiwmWaylandPointer *pointer,
                  const ClutterEvent *event)
{
  CobiwmWaylandPointerClient *pointer_client;
  struct wl_resource *resource;
...
gboolean
cobiwm_wayland_pointer_gesture_swipe_handle_event (CobiwmWaylandPointer *pointer,
                                                 const ClutterEvent *event)
{
...
void
cobiwm_wayland_pointer_gesture_swipe_create_new_resource (CobiwmWaylandPointer *pointer,
