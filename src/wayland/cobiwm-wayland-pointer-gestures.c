                    ...
                    struct wl_resource *pointer_resource)
{
  ...
  cobiwm_wayland_pointer_gesture_swipe_create_new_resource (pointer, client, resource, id);
}
                    ...
                    struct wl_resource *pointer_resource)
{
  ...
  cobiwm_wayland_pointer_gesture_pinch_create_new_resource (pointer, client, resource, id);
}
...
void
cobiwm_wayland_pointer_gestures_init (CobiwmWaylandCompositor *compositor)
{
  wl_global_create (compositor->wayland_display,
                    &zwp_pointer_gestures_v1_interface,
                    COBIWM_ZWP_POINTER_GESTURES_V1_VERSION,
