 ...
 *
 * This is a list of the names of all the X atoms that Cobiwm uses.
...
item(_COBIWM_TIMESTAMP_PING)
item(_COBIWM_FOCUS_SET)
item(_COBIWM_SENTINEL)
item(_COBIWM_VERSION)
