...
static gboolean
read_rgb_icon (CobiwmDisplay      *display,
               Window            xwindow,
               int               ideal_width,
               int               ideal_height,
               ...
               cairo_surface_t **mini_icon)
{
  ...
  result = XGetWindowProperty (display->xdisplay,
			       ...
			       &bytes_after, &data);
  err = cobiwm_error_trap_pop_with_return (display);
...
static void
get_pixmap_geometry (CobiwmDisplay *display,
                     Pixmap       pixmap,
                     int         *w,
                     int         *h,
                     int         *d)
...
static gboolean
try_pixmap_and_mask (CobiwmDisplay      *display,
                     Pixmap            src_pixmap,
                     Pixmap            src_mask,
...
static void
get_kwm_win_icon (CobiwmDisplay *display,
                  Window       xwindow,
                  Pixmap      *pixmap,
                  Pixmap      *mask)
{
...
void
cobiwm_icon_cache_init (CobiwmIconCache *icon_cache)
{
...
void
cobiwm_icon_cache_property_changed (CobiwmIconCache *icon_cache,
...
gboolean
cobiwm_icon_cache_get_icon_invalidated (CobiwmIconCache *icon_cache)
{
...
gboolean
cobiwm_read_icons (CobiwmScreen       *screen,
                 Window            xwindow,
                 ...
                 int               ideal_mini_height)
{
  ...
  *mini_iconp = NULL;
  ...
  if (!cobiwm_icon_cache_get_icon_invalidated (icon_cache))
