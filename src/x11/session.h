...
#ifndef COBIWM_SESSION_H
#define COBIWM_SESSION_H

#include "window-private.h"

typedef struct _CobiwmWindowSessionInfo CobiwmWindowSessionInfo;

struct _CobiwmWindowSessionInfo
{
 ...
 */
const CobiwmWindowSessionInfo* cobiwm_window_lookup_saved_state  (CobiwmWindow                  *window);
void                         cobiwm_window_release_saved_state (const CobiwmWindowSessionInfo *info);

void cobiwm_session_init (const char *client_id,
                        const char *save_file);


void cobiwm_session_shutdown (void);
