...
#ifndef COBIWM_WINDOW_PROPS_H
#define COBIWM_WINDOW_PROPS_H
 ...
 */
void cobiwm_window_reload_property_from_xwindow (CobiwmWindow      *window,
                                               Window           xwindow,
                                               Atom             property,
                                               gboolean         initial);

/**
 * cobiwm_window_load_initial_properties:
 * @window:      The window.
 *
 ...
 */
void cobiwm_window_load_initial_properties (CobiwmWindow *window);
 ...
 * display.
 */
void cobiwm_display_init_window_prop_hooks (CobiwmDisplay *display);

/**
 * cobiwm_display_free_window_prop_hooks:
 * @display:  The display.
 * Frees the hooks used for the reload_propert* functions
 * for a particular display.
 */
void cobiwm_display_free_window_prop_hooks (CobiwmDisplay *display);

/**
 * cobiwm_set_normal_hints:
 ...
 * for the X details.
 */
void cobiwm_set_normal_hints (CobiwmWindow *window,
			    XSizeHints *hints);

#endif /* COBIWM_WINDOW_PROPS_H */
