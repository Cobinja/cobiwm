...
#ifndef COBIWM_WINDOW_X11_PRIVATE_H
#define COBIWM_WINDOW_X11_PRIVATE_H
...
typedef struct _CobiwmWindowX11Private CobiwmWindowX11Private;

struct _CobiwmWindowX11
{
  CobiwmWindow parent;

  CobiwmWindowX11Private *priv;
};

struct _CobiwmWindowX11Private
{
